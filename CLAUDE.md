...
This is a **RAG (Retrieval-Augmented Generation) SaaS platform** - a polyglot monorepo application that allows users to upload documents and ask questions about them through an intelligent chat interface. Supports multi-modal content including PDFs, images, videos, and audio.
...
- Tiered subscriptions (Free/Basic/Pro) with usage limits
- Admin dashboard for user management

**Architecture**: Polyglot monorepo with multiple applications:
- `apps/web/`: Next.js 15 frontend with Supabase auth and Stripe billing
...
- **Frontend**: Next.js 15 (App Router), React 19, Supabase, Drizzle ORM, Stripe, AI SDK
...
npm run dev:full         # Start frontend + Stripe webhook listener
...
Configured in `apps/web/lib/subscriptions.ts`:

| Feature | Free | Basic | Pro |
|---------|------|-------|-----|
| Documents | 10 | 1,000 | Unlimited |
| Storage | 100 MB | 5 GB | 50 GB |
| Requests | 10/day | 1,000/month | Unlimited |
...
- `STRIPE_SECRET_KEY`, `STRIPE_WEBHOOK_SECRET`, `STRIPE_BASIC_PRICE_ID`, `STRIPE_PRO_PRICE_ID`, `STRIPE_CUSTOMER_PORTAL_URL`
